...
const String PRODUCT_FAILURE = 'product did not save';

class AddProductUserCase implements UseCase<void, Params> {
  ...
  Future<Either<Failure, void>> call(Params params) async {
    ...
    if (result.isLeft()) {
      return Left(PlaceholderFailure(errorMessage: PRODUCT_FAILURE));
    }
